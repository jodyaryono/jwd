...
<form id="bookingForm" method="post" action="proses_daftar.php">
    ...
    <label for="accomodation">Penginapan <input title="Akomodasi" type="checkbox" id="accomodation" name="accomodation"
            value="1000000"></label>

    <label for="Transportation">Transportasi<input title="Transportasi" type="checkbox" id="transportation"
            name="transportation" value="1200000"></label>

    <label for="Service">Servis/Makan<input title="Servis/Makanan" type="checkbox" id="service" name="service"
...
$(document).ready(function() {
    ...
    $('#travelDate').val(urlParams.get('days'));
